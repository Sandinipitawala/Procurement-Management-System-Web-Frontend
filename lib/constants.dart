...
const String URL_PENDING_ORDERS = "/orders/pending/";

//Constant for url path of approved orders
const String URL_APPROVED_ORDERS = "/orders/approved/";

//Constant for url path of hold orders
const String URL_HOLD_ORDERS = "/orders/hold/";

//Constant for url path of referred orders
const String URL_REFERRED_ORDERS = "/orders/referred/";

//Constant for url path of declined orders
const String URL_DECLINED_ORDERS = "/orders/declined/";
